...
class StatsController extends Controller
{
    public function stats()
    {
        ...
        $stats->colours->count = \App\Colour::all()->count();
        ...
        $stats->tags->count = \App\Tag::all()->count();
        ...
        $stats->countries->count = \App\Country::all()->count();
        ...
        $stats->logos->count = \App\Logo::all()->count() -1;
