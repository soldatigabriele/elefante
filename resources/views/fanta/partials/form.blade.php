...
<style>
    ...
    <div class="col-12">
            <div class="row">
                <div class="col-2 col">Logo</div>
                <div class="col-10 col cc-selector">
                    @foreach($logos as $logo)
                        <input type="radio" id="{{ $logo->name }}" name="logo" value="{{ $logo->id }}" @isset($fanta->logo) @if($fanta->logo_id == $logo->id) checked @endif @else @if(4 == $logo->id) checked @endif @endif>
